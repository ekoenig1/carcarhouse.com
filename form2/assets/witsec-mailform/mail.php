...
$to = "ekoenig1@outlook.de";														// To Address
$toAlt = "";												// Additional Recipients
$from = "ekoenig1@outlook.de";													// From Address
...
$smtpHost = "smtp.office365.com";											// SMTP Host
$smtpPort = "587";											// SMTP Port
$smtpSecure = "tls";										// SMTP Use SSL/TLS (empty, ssl or tls)
$smtpUsername = "ekoenig1@outlook.de";									// SMTP Username
$smtpPassword = "Finale@123";									// SMTP Password
